...
public class RecyclerViewAdapterForShop extends RecyclerView.Adapter<RecyclerViewAdapterForShop.DataHolder>  {
...
public RecyclerViewAdapterForShop(List<Category> l, Context c){
    this.listItems=l;
    this.context=c;
    ...
    public DataHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        else if(mFooterView != null &&viewType == TYPE_FOOTER)
        {
          return new DataHolder(mFooterView);
            ...
            View v = layoutInflater.inflate(R.layout.recyclerview_shoptop_listitem, parent, false);
    ...
    public void onBindViewHolder(DataHolder holder, final int position) {
        ...
        if(holder instanceof DataHolder) {
            holder.nickName.setText(listItem.getName());
            glideImageLoader.displayImage(context,listItem.getImgResource(),holder.imageView);
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mListener.onItemClick(position,listItem.getName());
                }
            });
        }
