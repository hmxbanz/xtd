...
public class MaterialProgressBar extends View {
    ...
    private int mBarWidth = (int) dp2px(3);/**轮子宽度*/
    //private int mBarColor = 0xFF5588FF;/**轮子颜色*/
    private int mBarColor = 0xFFFF69B4;/**轮子颜色*/
    private int mCircleRadius = (int) dp2px(25);/**轮子半径*/
    private int mSpinSpeed = 2;/**转速*/
    private float mProgress = 0.0f;/**当前进度 0~1.0f*/
    ...
    private int mRimColor = 0xFFFF1493;
