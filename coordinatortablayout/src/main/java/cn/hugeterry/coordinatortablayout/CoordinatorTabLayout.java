...
public class CoordinatorTabLayout extends CoordinatorLayout {
    ...
    private void initView(Context context) {
        ...
        mImageView = (ImageView) findViewById(R.id.img_top_bg);
    }
    ...
    private void initWidget(Context context, AttributeSet attrs) {
        ...
        int tabIndicatorColor = typedArray.getColor(R.styleable.CoordinatorTabLayout_tabIndicatorColor, getResources().getColor(R.color.mainColorPinkDark));
        mTabLayout.setSelectedTabIndicatorColor(tabIndicatorColor);

        int tabTextColor = typedArray.getColor(R.styleable.CoordinatorTabLayout_tabTextColor, getResources().getColor(R.color.mainColorPinkDark));
